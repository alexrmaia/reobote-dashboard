    ...
    * { box-sizing: border-box; }
    ...
    <div class="lw">
      <div class="lc">
        ...
        <!-- Logo -->
        <div class="logo-area">
          <p class="logo-brand">Seller<span>Pulse</span></p>
          <p class="logo-tagline">Dados &bull; Controle &bull; Lucro</p>
        ...
        <div class="glass-card">
          ...
          <p class="card-subtitle">Conecte-se com o Mercado Livre para<br>visualizar seus dados de vendas</p>

          <!-- Features -->
          <div class="features">
            <div class="feat"><div class="feat-dot"></div> Vendas em tempo real</div>
            <div class="feat"><div class="feat-dot"></div> FIFO automático</div>
            <div class="feat"><div class="feat-dot"></div> Lucro líquido</div>
          </div>
          ...
          <div class="security-row">
            ...
            <span class="security-text">🔒 OAuth 2.0 &bull; Acesso seguro</span>
            <div class="security-line"></div>
          </div>
        </div>

        <!-- Footer -->
        <p class="login-footer">SellerPulse &copy; 2026 &mdash; Reobote Imports</p>

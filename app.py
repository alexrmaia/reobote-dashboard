...
if "access_token" not in st.session_state:
    ...
    st.markdown(f"""
    <style>
    .main {{ background: #070B1A !important; }}
    ...
    .login-tagline {{
        ...
        text-transform: uppercase; color: #4B9AFF; margin-bottom: 40px;
    }}
    .login-title {{
